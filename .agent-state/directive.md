...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#41 merged. Coverage 68.09/66.71/77.88/67.77. PR#42 (`feat/e0-coverage-batch-30`) open awaiting CI: layout forbiddenAdjacentTerrain rejection.
