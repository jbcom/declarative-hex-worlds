...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#19 merged. PR#20 (`feat/e0-coverage-batch-10`) open awaiting CI: assertions movement no-candidates with eventRecords.
