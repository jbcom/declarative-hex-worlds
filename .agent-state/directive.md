...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#20 merged. PR#21 (`feat/e0-coverage-batch-11`) open awaiting CI: assertions movement+patrol no-candidates serialization.
