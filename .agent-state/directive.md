...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#22 merged. PR#23 (`feat/e0-coverage-batch-13`) open awaiting CI: defaultLayerForPlacementKind terrain + road.
