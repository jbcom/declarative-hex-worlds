...
- [ ] **E0a** — Simulation + patrol files toward 100%. Local floor advancing on PR#10. As of `07d96fe`:
    - **Overall:** 66.58 / 64.77 / 76.98 / 66.24 (was 62.5/60.5/75/62 at PR#4 merge — +4.1 pp statements). Threshold floor: 65/62.9/75.5/64.6 (CI-adjusted).
