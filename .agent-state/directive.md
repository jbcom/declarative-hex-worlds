...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#42 merged. PR#43 (`feat/e0-coverage-batch-31`) open awaiting CI: layout missing-required-tags + missing-adjacent-placement-layer.
