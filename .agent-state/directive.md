...
- [ ] **E0a** — Simulation + patrol files toward 100%. PR#10-#28 merged. PR#29 closed (sort test hit koota 16-world limit). PR#30 (`feat/e0-coverage-batch-19a`) open: pivoting to non-koota closures.
