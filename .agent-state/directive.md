...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#26 merged. PR#27 (`feat/e0-coverage-batch-17`) open awaiting CI: inspect-actor-targets center known tile via scenario.
