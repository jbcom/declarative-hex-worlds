...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#16 merged. PR#17 (`feat/e0-coverage-batch-7`) open awaiting CI: placement_reference empty + HexCoordinates target path.
