...
- [ ] [WAIT] **E0a** — Simulation + patrol files toward 100%. PR#10-#23 merged. PR#24 (`feat/e0-coverage-batch-14`) open awaiting CI: inspect-actor-targets center matches known tile.
