...
- [ ] **E0a** — Simulation + patrol files toward 100%. PR#10-#31 merged (koota world-cleanup setup landed). PR#32 (`feat/e0-coverage-batch-20`) open: koota-using closures now possible.
