...
`docs-site/src/content/docs/` is the human-facing canonical documentation site.
Use it first for consumer-facing guides, feature pages, architecture notes, and
reference pages generated by TypeDoc.

`docs/` remains load-bearing repo metadata: PRDs, architecture pillars,
...
`docs/guides/*.md` file points to a canonical docs-site URL, keep that file as
