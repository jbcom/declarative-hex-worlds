...
import { isGameboardInteractionHandlerPreset } from '../commands';
...
import {
  ...
  type GameboardScenarioSimulationScriptValidationConfig,
  type GameboardScenarioSimulationScriptValidationResult,
} from './script-types';
