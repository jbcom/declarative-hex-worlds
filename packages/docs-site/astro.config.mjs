...
const entryPoints = [
	'../declarative-hex-worlds/src/index.ts',
	'../declarative-hex-worlds/src/actors/index.ts',
	'../declarative-hex-worlds/src/scenario/blueprint.ts',
	'../declarative-hex-worlds/src/scenario/catalog.ts',
	'../declarative-hex-worlds/src/interop/compatibility.ts',
	'../declarative-hex-worlds/src/commands/index.ts',
	'../declarative-hex-worlds/src/interop/coverage.ts',
	'../declarative-hex-worlds/src/coordinates/index.ts',
	'../declarative-hex-worlds/src/gameboard/index.ts',
	'../declarative-hex-worlds/src/coordinates/grid.ts',
	'../declarative-hex-worlds/src/interop/index.ts',
	'../declarative-hex-worlds/src/koota/index.ts',
	'../declarative-hex-worlds/src/coordinates/layout.ts',
	'../declarative-hex-worlds/src/movement/index.ts',
	'../declarative-hex-worlds/src/gameboard/navigation.ts',
	'../declarative-hex-worlds/src/gameboard/occupancy.ts',
	'../declarative-hex-worlds/src/patrol/index.ts',
	'../declarative-hex-worlds/src/pieces/index.ts',
	'../declarative-hex-worlds/src/coordinates/projection.ts',
	'../declarative-hex-worlds/src/quests/index.ts',
	'../declarative-hex-worlds/src/scenario/recipe.ts',
	'../declarative-hex-worlds/src/scenario/registry.ts',
	'../declarative-hex-worlds/src/react/index.ts',
	'../declarative-hex-worlds/src/rules/rule-types.ts',
	'../declarative-hex-worlds/src/rules/index.ts',
	'../declarative-hex-worlds/src/runtime/index.ts',
	'../declarative-hex-worlds/src/scenario/index.ts',
	'../declarative-hex-worlds/src/selectors/index.ts',
	'../declarative-hex-worlds/src/simulation/index.ts',
	'../declarative-hex-worlds/src/systems/index.ts',
	'../declarative-hex-worlds/src/three/index.ts',
	'../declarative-hex-worlds/src/traits/index.ts',
	'../declarative-hex-worlds/src/errors/index.ts',
	'../declarative-hex-worlds/src/types/index.ts',
	'../declarative-hex-worlds/src/rules/validation.ts',
	'../declarative-hex-worlds/src/systems/world-rules-system.ts',
	'../declarative-hex-worlds/src/cli/cli.ts',
	'../declarative-hex-worlds/src/cli/commands/bootstrap/index.ts',
	'../declarative-hex-worlds/src/ingest/index.ts',
	'../declarative-hex-worlds/src/manifest/free.ts',
	'../declarative-hex-worlds/src/manifest/schema.ts',
	'../declarative-hex-worlds/src/cli/commands/bootstrap/upstream-layout.ts',
];
