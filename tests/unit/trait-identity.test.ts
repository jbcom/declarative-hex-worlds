...
import { GameboardActor as ActorViaUmbrella } from '@jbcom/medieval-hexagon-gameboard';
import { GameboardActor as ActorViaActors } from '@jbcom/medieval-hexagon-gameboard/actors';
import { GameboardActor as ActorViaTraits } from '@jbcom/medieval-hexagon-gameboard/traits';

import { IsGameboardTile as TileViaUmbrella } from '@jbcom/medieval-hexagon-gameboard';
import { IsGameboardTile as TileViaKoota } from '@jbcom/medieval-hexagon-gameboard/koota';
import { IsGameboardTile as TileViaTraits } from '@jbcom/medieval-hexagon-gameboard/traits';
